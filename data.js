...
const WORK_STORY = {
  title: "焼肉屋の煙と、夜の病院",
  body: [
    "学生時代のアルバイトは、ほとんど両極端な2つの場所で過ごしました。",
    "ひとつは焼肉屋です。煙と匂いと注文の声で埋まったピークの時間。チェーン店では、決められた型のとおりに速く正確に動くことを覚えました。次に個人経営の店へ移ると、今度はマニュアルがありません。同じ注文でも、急いでいる人と、ゆっくり話したい人では出し方が変わる。常連さんの顔と好みを覚えて、聞かれる前に動く。型を身につけたあとで、型のない場所に立たされた2年間でした。",
    "もうひとつは病院の夜勤です。昼間の音が全部消えたあとの、人の気配だけが残る廊下。ほとんどの時間は静かで、そこへ突然、電話が鳴ります。受付に立つ、家族に説明する、救急の受け入れの事務を回す。医療現場のいちばん表に出てこない時間帯を、2年間見てきました。",
    "焼肉屋で覚えたのは、目の前の人の状態を見て自分の動きを変えることでした。夜の病院で覚えたのは、静かな時間にどれだけ備えておけるかで、いざというときの動きが決まるということでした。",
    "この2つは、そのまま自分がつくるものの性格になっています。相手が迷わない画面をつくるのも、動かない自動化を何度も直して毎日走らせ続けるのも、たぶんあの時間に身についたものです。",
  ],
};
