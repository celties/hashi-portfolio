...
const EXPERIENCE = [
  {
    ...
    org: "実家の手伝い（ボランティア）",
    period: "2026.09",
    note: "実家の手伝いで紙の注文書を扱っていたところから、手書きの注文書をAIで読み取って集計する業務アプリを自分で作り、現場に入れた。報酬をもらう仕事としてではなく、身近な困りごとを解決するために始めたもの。要件を決めるところから運用まで、ひと通り自分で担当している。",
  },
  {
...
const CAREER = {
  ...
  steps: [
    ...
    },
    {
      ...
      note: "徒手理学療法の洋書を原書で読み、TOEIC L&R IPを受けてきました。米国のATC資格ルートも調査済みです。参加を計画しているスウェーデンの短期研修に向けて、現地の医療者とやり取りできる状態を目標にしています。読めるだけでは足りないので、話せるところまで。",
    },
    {
      no: "03",
  ...
  pillars: [
    {
      ...
      actions: [
        "「ジャンプ動作時の膝関節安定性」をテーマに、膝の動的アライメント・前十字靭帯・周囲筋群の協調制御を文献で調査。5分間の学術発表に向けて、構成案と発表フレームワークを作成した",
    ...
    },
    {
      ...
      actions: [
        "スウェーデンへの海外短期研修（IPEプログラム）への参加を計画中。事前学習として、現地の医療・リハビリテーション制度と多職種連携教育の到達目標を調べ、日本の仕組みとの違いを整理しているところ",
        "徒手理学療法の洋書を読み、日常・専門の英会話練習とTOEIC L&R IPテストの受験を継続。米国をはじめ海外で理学療法士になる資格ルートとキャリアパスを調査した",
      ],
      aim:
        "医療・福祉の先進国の現場を自分の目で見て、日本の仕組みとの差と多職種協働の実践モデルを理解したいから。将来、海外の最新知見を取り入れたり、グローバルに働く選択肢を持てるように。",
      tags: ["IPE", "スウェーデン短期研修（計画中）", "洋書講読", "TOEIC L&R"],
    },
    {
      no: "03",
      title: "スポーツ × テクノロジー",
