...
const INTERESTS = [
  { emoji: "🏀", label: "バスケットボール", note: "小学1年から現在までずっと。いまは大学のサークルでプレーしながら、小規模ながらサークル長も務めている。プレイヤー・学生コーチ・OBトレーナーと、立場を変えながら関わり続けてきた。好きなチームはボストン・セルティックス。選手ではアイザイア・トーマスとマーカス・スマートが好き。" },
...
const CAREER = {
  ...
  steps: [
    ...
    },
    {
      ...
      note: "徒手理学療法の洋書を原書で読み進めています。米国のATC資格ルートも調査済みです。参加を計画しているスウェーデンの短期研修に向けて、現地の医療者とやり取りできる状態を目標にしています。読めるだけでは足りないので、話せるところまで。",
    },
    {
      no: "03",
  ...
  pillars: [
    ...
    },
    {
      ...
      actions: [
        ...
        "徒手理学療法の洋書を原書で読み、日常・専門の英会話の練習を継続。米国をはじめ海外で理学療法士になる資格ルートとキャリアパスを調査した",
      ],
      aim:
        "医療・福祉の先進国の現場を自分の目で見て、日本の仕組みとの差と多職種協働の実践モデルを理解したいから。将来、海外の最新知見を取り入れたり、グローバルに働く選択肢を持てるように。",
      tags: ["IPE", "スウェーデン短期研修（計画中）", "洋書講読", "英会話"],
    },
    {
      no: "03",
      title: "スポーツ × テクノロジー",
