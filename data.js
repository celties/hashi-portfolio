...
const INTERESTS = [
  { emoji: "🏀", label: "バスケットボール", note: "小学1年から現在までずっと。プレイヤー・学生コーチ・OBトレーナーと、立場を変えながら競技に関わり続けている。NBAはボストン・セルティックス一筋。" },
...
const STRENGTHS = [
  ...
  { title: "3つの立場からコートを見た", note: "プレイヤー・学生コーチ・OBトレーナーのすべてを経験した。同じ1本のプレーが、やる側・教える側・支える側でどう違って見えるかを知っている。" },
